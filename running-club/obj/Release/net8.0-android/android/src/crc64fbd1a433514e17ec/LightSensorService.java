...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("running_club.Platforms.Android.LightSensorService, running-club", LightSensorService.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == LightSensorService.class) {
			mono.android.TypeManager.Activate ("running_club.Platforms.Android.LightSensorService, running-club", "", this, new java.lang.Object[] {  });
		}
	}
